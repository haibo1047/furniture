...
public class Generator {
	// 根据命名规范，只修改此常量值即可
		...
		private static String DATABASE = "activiti";
		private static String TABLE_PREFIX = "MEETING_";
		private static String PACKAGE_NAME = "com.huiyi.meeting";  //注意设置该变量，它会想service项目的该文件夹下覆盖写入东西
